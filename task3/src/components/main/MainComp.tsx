...
import TagsComp from "../tags/TagsComp";
import DataBox from "../dataBox/DataBox";
import MaskWrap from "../maskWrap/MaskWrap";

export default function MainComp(prop: { main: main }) {
  return (
    <main className="main">
      <div className="wrap">
        <div className="main__container">
          ...
          <div className="main__box">
            <TagsComp
              ...
              ulClassName="main__article-switchers"
              liClassName="main__article-item"
            />
